    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 20%;">Kode Pelanggan</th>
            ...
            <?php if (!empty($pelanggan)): ?>
                <?php foreach ($pelanggan as $index => $item): ?>
                    <tr>
                        ...
                        <td><?= esc($item['kode_pelanggan']) ?></td>
                        <td style="text-align: left; padding-left: 6px;"><?= esc($item['nama_pelanggan']) ?></td>
                        <td style="text-align: left; padding-left: 6px;"><?= esc($item['alamat'] ?? '-') ?></td>
