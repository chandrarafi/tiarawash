            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/antrian') ?>">Antrian</a></li>
                        ...
                        <div class="card-body">
                            <form method="GET" action="<?= site_url('admin/antrian/laporan') ?>" class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="<?= site_url('admin/antrian/export-pdf?tanggal_cetak=' . urlencode($tanggal_cetak)) ?>"
                    ...
                    <div class="card" id="printable-content">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4" id="report-header">
                                ...
                                <h3 class="text-center mb-3"><strong>Laporan Antrian</strong></h3>
                            </div>
                                ...
                                <table class="table table-bordered" style="font-size: 11px;">
                                    <thead style="background-color: #f8f9fa;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 12%;">nomor antrian</th>
                                            <th class="text-center" style="width: 12%;">idbooking</th>
                                            <th class="text-center" style="width: 15%;">tanggal</th>
                                            <th class="text-center" style="width: 10%;">jam mulai</th>
                                            <th class="text-center" style="width: 10%;">jam selesai</th>
                                        ...
                                        <?php if (!empty($antrian)): ?>
                                            <?php foreach ($antrian as $index => $item): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= esc($item['nomor_antrian']) ?></td>
                                                    <td class="text-center"><?= esc($item['kode_booking'] ?? $item['booking_id']) ?></td>
                                                    <td class="text-center"><?= $item['tanggal'] ? date('d/m/Y', strtotime($item['tanggal'])) : '-' ?></td>
                                                    <td class="text-center"><?= esc($item['jam_mulai'] ?? $item['jam'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['jam_selesai'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['status']) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr>
