            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/karyawan') ?>">Karyawan</a></li>
                    ...
                    <div class="card" id="printable-content">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4" id="report-header">
                                ...
                                <h3 class="text-center mb-3"><strong>Laporan Data Karyawan</strong></h3>
                            </div>
                                ...
                                <table class="table table-bordered" style="font-size: 11px;">
                                    <thead style="background-color: #f8f9fa;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 35%;">Nama Karyawan</th>
                                        ...
                                        <?php if (!empty($karyawan)): ?>
                                            <?php foreach ($karyawan as $index => $item): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= esc($item['idkaryawan']) ?></td>
                                                    <td><?= esc($item['namakaryawan']) ?></td>
                                                    <td><?= esc($item['alamat'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['nohp'] ?? '-') ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr>
