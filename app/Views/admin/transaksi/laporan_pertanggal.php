            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="<?= site_url('admin/transaksi/laporan-pertanggal') ?>" class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="<?= site_url('admin/transaksi/export-pertanggal-pdf?tanggal=' . urlencode($tanggal)) ?>"
                    ...
                    <div class="card" id="printable-content">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4" id="report-header">
                                ...
                                <h3 class="text-center mb-3"><strong>Laporan Transaksi Cuci<br>Pertanggal</strong></h3>
                            </div>
                                ...
                                <table class="table table-bordered" style="font-size: 11px;">
                                    <thead style="background-color: #f8f9fa;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 15%;">jenis jasa</th>
