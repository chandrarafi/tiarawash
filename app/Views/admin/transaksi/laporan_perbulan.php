            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="<?= site_url('admin/transaksi/laporan-perbulan') ?>" class="row">
                                <div class="col-md-3">
                                    <label for="periode">Periode (MM/YYYY):</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="<?= site_url('admin/transaksi/export-perbulan-pdf?periode=' . urlencode($periode)) ?>"
                    ...
                    <div class="card" id="printable-content">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-4" id="report-header">
                                ...
                                <h3 class="text-center mb-3"><strong>Laporan Transaksi Cuci<br>Perbulan</strong></h3>
                            </div>

                            <!-- Filter Info sesuai format gambar -->
                            <div class="mb-3">
                                <p class="mb-1">
                                    <strong>Periode :</strong> <?= $nama_bulan[$bulan] ?><?= $tahun ?>
                                </p>
                            </div>
                                ...
                                <table class="table table-bordered" style="font-size: 11px;">
                                    <thead style="background-color: #f8f9fa;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 12%;">kode pelanggan</th>
                                            <th class="text-center" style="width: 15%;">nama pelanggan</th>
                                            <th class="text-center" style="width: 13%;">nama karyawan</th>
                                            <th class="text-center" style="width: 12%;">jenis kendaraan</th>
                                            <th class="text-center" style="width: 8%;">no plat</th>
                                            <th class="text-center" style="width: 10%;">jenis jasa</th>
                                        ...
                                        <?php if (!empty($transaksi)): ?>
                                            <?php foreach ($transaksi as $index => $item): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= esc($item['kode_transaksi'] ?? '-') ?></td>
                                                    <td><?= esc($item['nama_pelanggan'] ?? '-') ?></td>
                                                    <td><?= esc($item['nama_karyawan'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['jenis_kendaraan'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['no_plat'] ?? '-') ?></td>
                                                    <td class="text-center"><?= esc($item['jenis_jasa'] ?? 'Cuci Mobil') ?></td>
                                                    <td class="text-center">Rp. <?= number_format($item['harga'] ?? 0, 0, ',', '.') ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <!-- Total Row -->
